...
/// Options for decoding ``PushDeeplink/PushDictionaryPayload`` implementing the `Decodable` protocol.
///
/// The options include different strategies for decoding data from user information associated with the push.
///
/// - SeeAlso: ``PushDeeplink``
public struct PushDeeplinkDictionaryPayloadOptions {
