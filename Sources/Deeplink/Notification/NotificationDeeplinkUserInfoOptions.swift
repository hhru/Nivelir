...
/// Options for decoding ``NotificationDeeplink/NotificationUserInfo`` implementing the `Decodable` protocol.
///
/// The options include different strategies for decoding data from user information associated with the notification.
///
