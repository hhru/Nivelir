...
internal final class URLQueryUnkeyedDecodingContainer: URLQueryComponentDecoder {

    internal let components: [URLQueryComponent?]
    ...
    internal init(
        components: [Int: URLQueryComponent],
    ...
    private func popNextComponent() throws -> URLQueryComponent? {
