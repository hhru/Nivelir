...
internal final class URLQueryKeyedDecodingContainer<Key: CodingKey>: URLQueryComponentDecoder {

    internal let components: [String: URLQueryComponent]
    internal let options: URLQueryDecodingOptions
    internal let userInfo: [CodingUserInfoKey: Any]
    internal let codingPath: [CodingKey]

    internal init(
        components: [String: URLQueryComponent],
