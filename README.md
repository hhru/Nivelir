...
[![Xcode](https://img.shields.io/badge/Xcode-26-blue)](https://developer.apple.com/xcode)
...
``` swift
.package(url: "https://github.com/hhru/Nivelir.git", from: "1.9.15")
```
